...
/**
 * @class nav2_mpc_controller::ModelPredictiveControl
 * @brief Regulated pure pursuit controller plugin
 */
class ModelPredictiveControl : public nav2_core::Controller
{
public:
  /**
   * @brief Constructor for nav2_mpc_controller::ModelPredictiveControl
   */
  ModelPredictiveControl() = default;

  /**
   * @brief Destrructor for nav2_mpc_controller::ModelPredictiveControl
   */
  ~ModelPredictiveControl() override = default;
...
//   geometry_msgs::msg::PoseStamped getLookAheadPoint(const double &, const nav_msgs::msg::Path &);
  ...
  rclcpp::Logger logger_ {rclcpp::get_logger("ModelPredictiveControl")};
